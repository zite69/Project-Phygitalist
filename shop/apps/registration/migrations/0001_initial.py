# Generated by Django 4.2.16 on 2024-11-16 05:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gstin', models.CharField(db_index=True, max_length=15, null=True, validators=[shop.apps.user.models.validate_length(15), shop.apps.registration.models.unique_in_db(shop.apps.user.models.Profile, 'gstin')], verbose_name='GSTIN Number')),
                ('pan', models.CharField(db_index=True, max_length=10, null=True, validators=[shop.apps.user.models.validate_length(10), shop.apps.registration.models.unique_in_db(shop.apps.user.models.Profile, 'pan')], verbose_name='PAN Number')),
                ...
                ('approval_status', models.CharField(db_index=True, default='I', max_length=2, verbose_name='Approval Status')),
