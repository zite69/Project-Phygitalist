# Generated by Django 4.2.15 on 2024-08-28 22:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, region='IN', unique=True, verbose_name='Phone Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('B', 'Buyer'), ('S', 'Seller'), ('O', 'Both'), ('C', 'CEO')], db_index=True, max_length=4, verbose_name='User Profile Type')),
                ('gstin', models.CharField(blank=True, db_index=True, max_length=15, null=True, unique=True, validators=[shop.apps.user.models.validate_length(15)], verbose_name='GSTIN Number')),
                ('pan', models.CharField(blank=True, db_index=True, max_length=10, null=True, unique=True, validators=[shop.apps.user.models.validate_length(10)], verbose_name='PAN Number')),
